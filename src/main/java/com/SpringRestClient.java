...
public class SpringRestClient {
    ...
    public static void main(String[] args) {
        ...
        springRestClient.findEmployee();

        // Step3: get all employees
        springRestClient.findEmployees();
    ...
    private void findEmployee() {
        ...
        EmployeeModel result = restTemplate.getForObject(GET_EMPLOYEE_ENDPOINT_URL, EmployeeModel.class, params);
    ...
    private void createEmployee() {
        ...
        RestTemplate restTemplate = new RestTemplate();
        EmployeeModel result = restTemplate.postForObject(CREATE_EMPLOYEE_ENDPOINT_URL, newEmployee, EmployeeModel.class);
